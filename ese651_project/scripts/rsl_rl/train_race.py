...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlOnPolicyRunnerCfg):
    ...
    position_reward_scale = 1.5         # Reward for getting closer to gate
    velocity_reward_scale = 0.1         # Penalty for high velocity
    orientation_reward_scale = 0.5      # Penalty for bad orientation
    ang_vel_reward_scale = 0.05         # Penalty for high angular velocity
    action_smooth_reward_scale = 0.01   # Penalty for abrupt actions
    crash_reward_scale = 5.0            # Penalty for crashing
    death_cost = -10.0                  # Cost for death

    # Assemble rewards dictionary
    rewards = {
        # 'progress_gate_reward_scale': progress_gate_reward_scale,
        'position_reward_scale': position_reward_scale,
        ...
        'action_smooth_reward_scale': action_smooth_reward_scale,
